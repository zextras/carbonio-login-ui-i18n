												...
												mp: [
													{
														...
														body: true,
														content: {
															_content: `<html><body><div style="font-family: arial, helvetica, sans-serif; font-size: 12pt; color: #000000"><div><strong>Secret Code</strong><br>${qrData}</div><div><br></div><div><img src="${
																window?.document?.getElementsByTagName('canvas')[0]?.toDataURL() ||
																''
															}"></div><div><br></div>${map(
																pinCodes,
																(singleCode: any) =>
																	`<div><span style="font-family: monospace; font-size: medium;" data-mce-style="font-family: monospace; font-size: medium;">${singleCode.code}</span></div>`
															).join('')}</div></body></html>`
														}
													}
												]
